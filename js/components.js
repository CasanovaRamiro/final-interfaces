...
class Components {
    static navbar() {
        return `
            <nav>
                <ul class="nav-ul">
                    <li class="nav-li container-logo" id="li-home-largo"><img class="foto-logo" src="img/logo.png" alt="logo"><a href="home.html" class="interno">Memorial Chastain Park</a></li>
